...
cd ../swin_od_220304
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.launch --master_port 12345 --nproc_per_node=1 \
    tools/train.py configs/_swin_gmm/tiny_p4w7.py \
    --work-dir /host/ubuntu/vision/swin_od --launcher pytorch


CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.launch --master_port 12345 --nproc_per_node=1 \
    tools/train.py configs/_swin_gmm/mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_adamw_1x_coco.py \
    --work-dir /host/ubuntu/vision/swin_od --launcher pytorch

CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.launch --master_port 12345 --nproc_per_node=1 \
    tools/train.py configs/swin/mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_adamw_1x_coco.py \
    --work-dir /host/ubuntu/vision/swin_od
